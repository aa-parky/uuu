    ...
    <div class="container letter">
        ...
        <div class="header">
            <div id="flex-header-left">
                <img src="/images/ezgif.com-optimize.gif" class="stamp-header" alt="stamp">
            </div>
        ...
        <div class="row news-columns-top">
            ...
            <div class="col-lg-2 col-md-6 col-sm-12">
                <div class="card mt-8">
                    <p><img src="/images/field-office-02.png" class="img-fluid photos-ads-no-border" alt="Field Office"></p>
                    <p><img src="/images/play-online-02.png" class="img-fluid photos-ads-no-border" alt="Play Online"></p>
